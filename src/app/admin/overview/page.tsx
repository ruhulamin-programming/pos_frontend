...
import { useSellsSummaryQuery } from "@/lib/services/orderApi";
import { CircleDollarSign, ListOrdered, ShoppingCart } from "lucide-react";
import Link from "next/link";

const OverViewPage = () => {
  const { data: sellsSummary, isLoading } = useSellsSummaryQuery({});

  const summary = sellsSummary?.data || {};
